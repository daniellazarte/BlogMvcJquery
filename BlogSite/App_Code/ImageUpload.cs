...
namespace Blog.Util
{
    public class ImageUpload
    {
        ...
        private readonly string UploadPath = "~/Content/Static/image/";
        private readonly string UploadPathImage = "~/Content/Static/image/preview";

        public ImageResult RenameUploadFile(HttpPostedFileBase file, Int32 counter = 0)
        {
            var fileName = Path.GetFileName(file.FileName);

            string prepend = "ImageBlog_";
        ...
        private ImageResult UploadFile(HttpPostedFileBase file, string fileName)
        {
            ...
            var pathImage = Path.Combine(HttpContext.Current.Request.MapPath(UploadPathImage), fileName);
            ...
            try
            {
                ...
                //Image imgOriginal2 = Image.FromFile(path);
